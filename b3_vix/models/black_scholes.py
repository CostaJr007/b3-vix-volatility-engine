"""Vectorized Black-Scholes-Merton Pricing and Analytical Greeks Engine for B3."""
...
class B3BlackScholesEngine:
    """Analytical Black-Scholes-Merton engine supporting B3 DU-252 convention and dividends."""
    ...
    def greeks(
        ...
        is_call = (flag.lower() == "call")
        theta_basis = 252.0 if business_days_basis else 365.0
